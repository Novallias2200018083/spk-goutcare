...
class DetailRiwayatRekomendasi extends Model
{
    ...
    public function getAiInsightAttribute()
    {
        ...
        if ($purinMakanan > $toleransiPurin || $this->nilai_akhir < 3.5) {
            $insight = "**ANALISIS : TIDAK DIREKOMENDASIKAN**\n\n";
            ...
            if ($this->nilai_akhir < 3.5) {
                $insight .= "Selain itu, profil makronutrisi makanan ini **meleset** dari angka ideal yang dibutuhkan oleh fisik Anda (Skor kecocokan hanya " . number_format($this->nilai_akhir, 2) . " / 5.0). ";
            }
        ...
        // Jika Purin Aman dan Skor >= 3.5
            ...
            if ($this->nilai_akhir >= 4.0) {
                ...
                $insight = "**ANALISIS : CUKUP DIREKOMENDASIKAN**\n\n";
