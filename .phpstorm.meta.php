...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\spk-gout\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\spk-gout\\public\\storage',
...
'profile.destroy','pasien.dashboard','pasien.profil.show','pasien.profil.create','pasien.profil.store',
'pasien.profil.edit','pasien.profil.update','pasien.rekomendasi.index','pasien.rekomendasi.history','admin.dashboard',
'admin.makanan.index','admin.makanan.create','admin.makanan.store','admin.makanan.show','admin.makanan.edit',
'admin.makanan.update','admin.makanan.destroy','admin.kriteria.index','admin.kriteria.create','admin.kriteria.store',
'admin.kriteria.show','admin.kriteria.edit','admin.kriteria.update','admin.kriteria.destroy','dashboard',
