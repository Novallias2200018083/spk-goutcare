...
<head>
    ...
    <style>
        ...
        /* On mobile: compact vertical padding only */
        ...
        /* ─── MOBILE: hide branding, compact form ─── */
        @media (max-width: 1023px) {
            .branding-panel {
                ...
                <div class="flex flex-col lg:flex-row lg:min-h-[600px]">
                    ...
                    <div class="branding-panel lg:w-1/2 p-6 sm:p-8 lg:p-12 flex flex-col justify-center items-center text-center lg:text-left relative animate-fade-in-left">
                        ...
                        <div class="relative z-10 max-w-md mt-2">
                            <h1 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent mb-3 sm:mb-4 tracking-tight">
                                Selamat Datang di GoutCare!
                            </h1>
                            <p class="text-sm sm:text-base lg:text-lg text-light-secondary leading-relaxed font-medium px-2 sm:px-0">
                                Daftar sekarang untuk mulai mengelola kesehatan Anda dengan rekomendasi makanan yang tepat.
                            </p>
                        </div>
                    ...
                    <div class="form-panel lg:w-1/2 p-5 sm:p-8 lg:p-12 flex flex-col justify-center animate-fade-in-right bg-white/60 dark:bg-gray-900/60 backdrop-blur-md relative">
                        <div class="w-full max-w-md mx-auto">
                            ...
                            <div class="text-center lg:text-left mb-3 sm:mb-5">
                                ...
                                <p class="text-xs sm:text-sm text-light-secondary">
                                    Sudah punya akun?
                                    <a href="{{ route('login') }}" class="font-bold text-emerald-600 hover:text-emerald-500 transition-colors border-b border-transparent hover:border-emerald-500 pb-0.5">
                                        Masuk di sini
                                    </a>
                                </p>
                            </div>
