        ...
        <div class="w-full max-w-6xl animate-fade-in-up">
            <div class="glass-effect rounded-3xl shadow-2xl overflow-hidden">
                <div class="flex flex-col lg:flex-row min-h-[600px]">
                    ...
                    <div class="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center items-center text-center lg:text-left relative animate-fade-in-left">
                        ...
                        <div class="relative z-10 max-w-md">
                            <h1 class="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent mb-4">
                                Selamat Datang Kembali
                            </h1>
                            <p class="text-lg text-light-secondary leading-relaxed">
                                Kelola kesehatan Anda dengan rekomendasi makanan yang tepat dan pantau kondisi asam urat secara real-time.
                            </p>
                        </div>

                        <div class="relative z-10 grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8 w-full max-w-md">
                    ...
                    <div class="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center animate-fade-in-right">
                        <div class="w-full max-w-md mx-auto">

                            <div class="text-center lg:text-left mb-8">
                                <h2 class="text-3xl font-bold text-light-primary mb-2">
                                    Masuk ke Akun Anda
                                </h2>
                                ...
                                <div class="mt-6">
                                    <div class="relative">
                                        ...
                                        <div class="relative flex justify-center text-sm">
                                            <span class="px-2 bg-white dark:bg-gray-800 text-light-muted">
                                                Atau masuk dengan
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-6 grid grid-cols-2 gap-3">
                                        <button type="button" class="w-full inline-flex justify-center py-2.5 px-4 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-sm font-medium text-light-secondary hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
