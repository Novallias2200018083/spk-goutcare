            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-3xl border border-gray-100 transition-all duration-300 hover:shadow-3xl transform animate-fade-in-up-once">
                <div class="p-6 sm:p-10 text-gray-900 relative z-10">
                    <div class="text-center mb-8">
                        <h3 class="font-extrabold text-3xl text-purple-800 mb-2 animate-fade-in-down-x">Lengkapi Profil Gizi Anda</h3>
                        <p class="text-gray-600 text-lg animate-fade-in-up-x">Berikan informasi ini untuk mendapatkan rekomendasi makanan yang personal dan akurat.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('pasien.profil.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            ...
                            <div class="mb-4 animate-slide-in-left-smooth">
                                ...
                                <x-text-input id="kebutuhan_kalori" class="block mt-1 w-full p-3 rounded-lg border-gray-300 focus:border-purple-500 focus:ring-purple-500 transition duration-150 ease-in-out shadow-sm" type="number" step="1" name="kebutuhan_kalori" :value="old('kebutuhan_kalori')" placeholder="Contoh: 2000" required />
                            ...
                            <div class="mb-4 animate-slide-in-right-smooth">
                                ...
                                <x-text-input id="kebutuhan_protein" class="block mt-1 w-full p-3 rounded-lg border-gray-300 focus:border-purple-500 focus:ring-purple-500 transition duration-150 ease-in-out shadow-sm" type="number" step="0.1" name="kebutuhan_protein" :value="old('kebutuhan_protein')" placeholder="Contoh: 60" required />
                            ...
                            <div class="mb-4 animate-slide-in-left-smooth" style="animation-delay: 0.7s;">
                                ...
                                <x-text-input id="kebutuhan_lemak" class="block mt-1 w-full p-3 rounded-lg border-gray-300 focus:border-purple-500 focus:ring-purple-500 transition duration-150 ease-in-out shadow-sm" type="number" step="0.1" name="kebutuhan_lemak" :value="old('kebutuhan_lemak')" placeholder="Contoh: 30" required />
                            ...
                            <div class="mb-4 animate-slide-in-right-smooth" style="animation-delay: 0.8s;">
                                ...
                                <x-text-input id="toleransi_purin" class="block mt-1 w-full p-3 rounded-lg border-gray-300 focus:border-purple-500 focus:ring-purple-500 transition duration-150 ease-in-out shadow-sm" type="number" step="1" name="toleransi_purin" :value="old('toleransi_purin')" placeholder="Contoh: 150" required />
                        ...
                        <div class="mt-8 animate-fade-in-slow" style="animation-delay: 0.9s;">
                            ...
                            <textarea id="catatan_tambahan" name="catatan_tambahan" rows="5" class="block mt-1 w-full p-3 rounded-lg border-gray-300 focus:border-purple-500 focus:ring-purple-500 transition duration-150 ease-in-out shadow-sm" placeholder="Contoh: Alergi udang, tidak suka brokoli, dll.">{{ old('catatan_tambahan') }}</textarea>
                        ...
                        {{-- Submit Button --}}
                        <div class="flex items-center justify-center mt-10 animate-fade-in-slow" style="animation-delay: 1.2s;">
                            <button type="submit" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 border border-transparent rounded-full font-extrabold text-white text-base uppercase tracking-wider shadow-xl hover:shadow-2xl transform hover:scale-110 transition duration-300 ease-in-out animate-pulse-subtle">
                                <i class="fas fa-check-circle mr-3 text-xl"></i> {{ __('Simpan Profil Saya') }}
                            </button>
                        </div>
                    </form>
                </div>
