                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.kriteria.store') }}">
                        ...
                        <div class="mb-5">
                            ...
                            <x-text-input id="nama_kriteria" class="block mt-1 w-full" type="text" name="nama_kriteria" :value="old('nama_kriteria')" required autofocus />
                            <x-input-error :messages="$errors->get('nama_kriteria')" class="mt-2" />
                        </div>

                        <div class="mb-5">
                            <x-input-label for="bobot" :value="__('Bobot (untuk SAW)')" />
                            <x-text-input id="bobot" class="block mt-1 w-full" type="number" step="0.01" min="0" max="1" name="bobot" :value="old('bobot')" required />
