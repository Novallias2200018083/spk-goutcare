                    ...
                    <form method="POST" action="{{ route('admin.kriteria.store') }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input id="nama_kriteria" type="text" name="nama_kriteria" value="{{ old('nama_kriteria') }}" required autofocus placeholder="Misal: Kadar Purin"
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <label class="relative flex flex-col p-4 border border-slate-200 rounded cursor-pointer hover:bg-slate-50 transition-colors has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50">
                                        <input type="radio" name="tipe_faktor" value="Core" class="hidden" required {{ old('tipe_faktor') == 'Core' ? 'checked' : '' }}>
                                    ...
                                    <label class="relative flex flex-col p-4 border border-slate-200 rounded cursor-pointer hover:bg-slate-50 transition-colors has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50">
                                        <input type="radio" name="tipe_faktor" value="Secondary" class="hidden" required {{ old('tipe_faktor') == 'Secondary' ? 'checked' : '' }}>
