                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.makanan.store') }}">
                        ...
                        <div class="mb-5">
                            ...
                            <x-text-input id="nama_makanan" class="block mt-1 w-full" type="text" name="nama_makanan" :value="old('nama_makanan')" required autofocus />
                        ...
                        <p class="text-sm text-gray-600 mb-4">Masukkan nilai nutrisi untuk setiap kriteria berikut. Perhatikan tipe kriteria (Benefit/Cost).</p>
                        ...
                        @foreach ($kriterias as $kriteria)
                            <div class="mb-5">
                                ...
                                <x-text-input id="nilai_kriteria_{{ $kriteria->id }}" class="block mt-1 w-full" type="number" step="0.01" name="nilai_kriteria[{{ $kriteria->id }}]" :value="old('nilai_kriteria.' . $kriteria->id)" required />
